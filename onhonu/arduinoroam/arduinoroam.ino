...
void setup() {
  ...
  LMO.attach(5);      //left motor on PWM input 5
  RMO.attach(6);      //right motor on PWM input 6
  DMO.attach(9);      //door motor on PWM input 9
}
